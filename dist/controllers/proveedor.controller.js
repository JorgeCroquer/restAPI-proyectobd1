...
const getProveedores = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield PoolEnUso.query('SELECT * FROM persona_juridica WHERE rif_jur IN (SELECT fk_rif_jur FROM proveedor)');
...
const createProveedor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield PoolEnUso.query('INSERT INTO proveedor VALUES ($1,$2)', [fk_rif_jur, marca_propia]);
...
const updateProveedor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { fk_rif_jur, marca_propia } = req.body;
        const response = yield PoolEnUso.query('UPDATE proveedor SET marca_propia = $1  WHERE fk_rif_jur = $2', [marca_propia, fk_rif_jur]);
...
const deleteProveedor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield PoolEnUso.query('DELETE FROM proveedor WHERE fk_rif_jur = $1', [id]);
